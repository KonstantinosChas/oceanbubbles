...
clear im_name im_name_aux
im_name = cell(1,NUM-NUM_in+1);
im_name_aux = cell(1,NUM-NUM_in+1);
...
% ROI = {'ROI1','ROI2','ROI3','ROI4','ROI5','ROI6'};
% run = {'run3','run3','run3','run3','run3','run3'};
% ROI = {'ROI6'};
% run = {'run3'};
% run = {'run3','run3','run3','run3','run3','run3'};
%% ------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if T ==0
    %WINDOWS 
%   C:\Users\Konstaninos\OneDrive - University College London\Desktop\Work\third year\laboratory\bubbles\data\saltwater\300621\GW_18\entire_video\ROI0\run1
            ...
            dir = ['C:\Users\Konstaninos\OneDrive - University College London\Desktop\Work\third year\laboratory\bubbles\data\',stage_save,'\',...
            date,'\',wave,'\',stage,'\',ROI{case_idx},'\',run{case_idx},'\'];  % directory of images to analyze
            dir_save = ['C:\Users\Konstaninos\OneDrive - University College London\Desktop\Work\third year\laboratory\bubbles\data\',stage_save,'\',...
            date,'\',wave,'\',stage,'\ROI1-8'];
            dir_save_rep = ['C:\Users\Konstaninos\OneDrive - University College London\Desktop\Work\third year\laboratory\bubbles\data\',stage_save,'\',...
            date,'\',wave,'\',stage,'\ROI1-8\',rep,'\'];
        elseif T==1
    %LINUX
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % aux_alpha_ins_ROI6 = cell(1,NUM); aux_alpha_ins_ROI7 = cell(1,NUM); aux_alpha_ins_ROI8 = cell(1,NUM); aux_alpha_ins_ROI9 = cell(1,NUM);
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    aux_BSD_ROI6 = zeros(NUM,30);
    aux_BSD_ROI7 = zeros(NUM,30);
    aux_BSD_ROI8 = zeros(NUM,30);
    aux_BSD_ROI9 = zeros(NUM,30);
            for i=NUM_in:NUM
         % store BSD results for each new ROI for each image 
            ...
            aux_BSD_ROI6_2 = zeros(1,30);
            aux_BSD_ROI7_2 = zeros(1,30);
            aux_BSD_ROI8_2 = zeros(1,30);
            aux_BSD_ROI9_2 = zeros(1,30);
            for k = 1:numel(BSDX_median)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %% time average for VBSD
                aux_VBSD_ROI6_2 = zeros(NUM,30);aux_VBSD_ROI7_2 = zeros(NUM,30);aux_VBSD_ROI8_2 = zeros(NUM,30);aux_VBSD_ROI9_2 = zeros(NUM,30);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        for i=NUM_in:NUM
            for k = 1:numel(BSDX_median)
...
%% time averaged VBSD:
                VBSD_ROI6_avg_2 = zeros(1,30);VBSD_ROI7_avg_2 = zeros(1,30);VBSD_ROI8_avg_2 = zeros(1,30);VBSD_ROI9_avg_2 = zeros(1,30);
...
%% for methodology description, see details in oldROI5 part.
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            cd(['C:\Users\Konstaninos\OneDrive - University College London\Desktop\Work\third year\laboratory\bubbles\data\',stage_save,'\',...
            date,'\',wave,'\',stage,'\ROI1-8\textfiles\']);
            for i = 1:(time_idx_end - time_idx_in)
            fid=fopen(['centers_ins_ROI4.',(im_name{i}),'.old',ROI{case_idx},'.',run{case_idx},'.txt'],'wt');
            header1 = 'y(mm)';
            header2 = 'x(mm)';
